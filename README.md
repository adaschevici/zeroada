...
![zeroada Light and Dark Theme](screenshot.png)

### Installation

To get started with zeroada, follow these simple steps:
...
2. Enable zeroada in your `config.toml`:
...
zeroada provides various options to customize your website:
...
The zeroada theme is available as open source under the terms of the [MIT License](LICENSE).
